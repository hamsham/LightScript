 ...
 */
class LS_SCRIPT_API Variable : public Scriptable
{
  public:
    /**
     *  @brief
     ...
     *
     *  @return ls::script::ScriptBaseType::SCRIPT_VAR
     */
 ...
 */
    ...
    #define LS_SCRIPT_VAR_DATA(pVar, varName) \
            static_cast<ScriptVar_##varName*>((ls::script::Variable*)pVar.get())->data
 ...
 */
#ifndef _LS_SCRIPT_DECLARE_VAR_IMPL
    #define _LS_SCRIPT_DECLARE_VAR_IMPL(LS_SCRIPT_API_TYPE, varName, varType) \
        \
        enum : ls::script::hash_t { \
            ScriptHash_##varName = LS_SCRIPT_HASH_FUNC(LS_STRINGIFY(varType)) \
        }; \
        \
        LS_SCRIPT_API_TYPE extern const ls::script::VarFactory_t& ScriptFactory_##varName; \
        \
        typedef ls::script::Variable_t<ScriptHash_##varName, varType> ScriptVar_##varName; \
        \
        LS_SCRIPT_EXTERN template class LS_SCRIPT_API_TYPE ls::script::Variable_t<ScriptHash_##varName, varType>
#endif /* _LS_SCRIPT_DECLARE_VAR_IMPL */

#ifndef LS_SCRIPT_DECLARE_VAR
    #define LS_SCRIPT_DECLARE_VAR(varName, varType) _LS_SCRIPT_DECLARE_VAR_IMPL(LS_SCRIPT_STATIC_API, varName, varType)
#endif /* LS_SCRIPT_DECLARE_VAR */

#ifndef LS_SCRIPT_DECLARE_VAR_SHARED
    #define LS_SCRIPT_DECLARE_VAR_SHARED(varName, varType) _LS_SCRIPT_DECLARE_VAR_IMPL(LS_SCRIPT_API, varName, varType)
#endif /* LS_SCRIPT_DECLARE_VAR_SHARED */
 ...
 *      delete pVar;
 */
#ifndef _LS_SCRIPT_DEFINE_VAR_IMPL
    #define _LS_SCRIPT_DEFINE_VAR_IMPL(LS_SCRIPT_API_TYPE, varName, varType) \
        \
        template class LS_SCRIPT_API_TYPE ls::script::Variable_t<ScriptHash_##varName, varType>; \
        \
        LS_SCRIPT_API_TYPE const ls::script::VarFactory_t& ScriptFactory_##varName = ls::script::register_var_factory( \
    ...
    #define LS_SCRIPT_DEFINE_VAR(varName, varType) _LS_SCRIPT_DEFINE_VAR_IMPL(LS_SCRIPT_STATIC_API, varName, varType)
#endif /* LS_SCRIPT_DEFINE_VAR */

#ifndef LS_SCRIPT_DEFINE_VAR_SHARED
    #define LS_SCRIPT_DEFINE_VAR_SHARED(varName, varType) _LS_SCRIPT_DEFINE_VAR_IMPL(LS_SCRIPT_EXPORT_API, varName, varType)
#endif /* LS_SCRIPT_DEFINE_VAR_SHARED */
 ...
 */
    ...
    #define LS_SCRIPT_OVERRIDE_VAR_LOAD(LS_SCRIPT_API_TYPE, varType) \
        \
        template <> \
        LS_SCRIPT_API_TYPE bool ls::script::Variable_t<LS_SCRIPT_HASH_FUNC(LS_STRINGIFY(varType)), varType>::load( \
            std::istream&  istr, \
 ...
 */
    ...
    #define LS_SCRIPT_OVERRIDE_VAR_SAVE(LS_SCRIPT_API_TYPE, varType) \
        \
        template <> \
        LS_SCRIPT_API_TYPE bool ls::script::Variable_t<LS_SCRIPT_HASH_FUNC(LS_STRINGIFY(varType)), varType>::save(std::ostream& ostr) const
