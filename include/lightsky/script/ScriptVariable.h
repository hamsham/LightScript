 ...
 */
    ...
    #define _LS_SCRIPT_DECLARE_VAR_IMPL(LS_API_TYPE, varName, varType) \
        \
        enum : ls::script::hash_t { \
            ScriptHash_##varName = LS_SCRIPT_HASH_FUNC(LS_STRINGIFY(varType)) \
        }; \
        \
        LS_API_TYPE extern const ls::script::VarFactory_t& ScriptFactory_##varName; \
        \
        typedef ls::script::Variable_t<ScriptHash_##varName, varType> ScriptVar_##varName; \
        \
        LS_EXTERN template class LS_API_TYPE ls::script::Variable_t<ScriptHash_##varName, varType>
#endif /* _LS_SCRIPT_DECLARE_VAR_IMPL */

#ifndef LS_SCRIPT_DECLARE_VAR
    #define LS_SCRIPT_DECLARE_VAR(varName, varType) _LS_SCRIPT_DECLARE_VAR_IMPL(LS_STATIC_API, varName, varType)
#endif /* LS_SCRIPT_DECLARE_VAR */

#ifndef LS_SCRIPT_DECLARE_VAR_SHARED
    #define LS_SCRIPT_DECLARE_VAR_SHARED(varName, varType) _LS_SCRIPT_DECLARE_VAR_IMPL(LS_API, varName, varType)
 ...
 */
    ...
    #define _LS_SCRIPT_DEFINE_VAR_IMPL(LS_API_TYPE, varName, varType) \
        \
        template class LS_API_TYPE ls::script::Variable_t<ScriptHash_##varName, varType>; \
        \
    ...
    #define LS_SCRIPT_DEFINE_VAR(varName, varType) _LS_SCRIPT_DEFINE_VAR_IMPL(LS_STATIC_API, varName, varType)
#endif /* LS_SCRIPT_DEFINE_VAR */

#ifndef LS_SCRIPT_DEFINE_VAR_SHARED
    #define LS_SCRIPT_DEFINE_VAR_SHARED(varName, varType) _LS_SCRIPT_DEFINE_VAR_IMPL(LS_EXPORT_API, varName, varType)
 ...
 */
    ...
    #define LS_SCRIPT_OVERRIDE_VAR_LOAD(LS_API_TYPE, varType) \
        \
        template <> \
        LS_API_TYPE bool ls::script::Variable_t<LS_SCRIPT_HASH_FUNC(LS_STRINGIFY(varType)), varType>::load( \
            std::istream&  istr, \
 ...
 */
    ...
    #define LS_SCRIPT_OVERRIDE_VAR_SAVE(LS_API_TYPE, varType) \
        \
        template <> \
        LS_API_TYPE bool ls::script::Variable_t<LS_SCRIPT_HASH_FUNC(LS_STRINGIFY(varType)), varType>::save(std::ostream& ostr) const
